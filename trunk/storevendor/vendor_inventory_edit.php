...
if (isset($_POST['product_name'])) {
  ...
  $quantity = mysql_real_escape_string($_POST['quantity']);
	...
	$sql = mysql_query("UPDATE products SET product_name='$product_name', price='$price', details='$details', category='$category', subcategory='$subcategory',vendor='$vendor', quantity='$quantity' WHERE id='$pid'");
...
if ($productCount > 0) {
	while($row = mysql_fetch_array($sql)){ 
       ...
       $quantity = $row["quantity"];
			 ...
			 $product_list .= "Product ID: $id - <strong>$product_name</strong> - $$price - <em>Added $date_added</em> &nbsp; &nbsp; &nbsp; <a href='vendor_inventory_edit.php?pid=$id'>edit</a> &bull; <a href='vendor_inventory_list.php?deleteid=$id'>delete</a><br />";
    }
} else {
...
<body>
  ...
  <div id="pageContent"><br />
    <div align="right" style="margin-right:32px;"><a href="vendor_inventory_list.php#inventoryForm">+ Add New Inventory Item</a></div>
<div align="left" style="margin-left:24px;">
    ...
    <form action="vendor_inventory_edit.php" enctype="multipart/form-data" name="myForm" id="myform" method="post">
 ...
 <td align="right">Quantity</td>
      <td>
        <label>
          <input name="quantity" type="text" id="quantity" size="2" value="<?php echo $quantity; ?>">
        </label>
      </td>
      <tr>
      ...
      <tr>
        ...
        <td><label>
          ...
          <a href="vendor_inventory_list.php"><input type="button" name="button" id="button" value="Back"/></a>
        </label></td>
      </tr>
    </table>
    </form>
