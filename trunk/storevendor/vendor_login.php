...
if (isset($_POST["username"]) && isset($_POST["password"])) {
	...
	$vendor = preg_replace('#[^A-Za-z0-9]#i', '', $_POST["username"]); // filter everything but numbers and letters
    $password = preg_replace('#[^A-Za-z0-9]#i', '', $_POST["password"]); // filter everything but numbers and letters
    // Connect to the MySQL database  
    include "../storescripts/connect_to_mysql.php"; 
    $sql = mysql_query("SELECT id FROM vendor WHERE username='$vendor' AND password='$password' LIMIT 1"); // query the person
...
<body>
  ...
  <div id="pageContent" class= "container">
    ...
    <div align="left" style="margin-left:24px;">
      <h2>Please Log In To Manage the Account</h2>
      <form id="form1" name="form1" method="post" action="vendor_login.php">
      ...
      <p>&nbsp; </p>
      <a href="vendor_register.php">Register here</a>
    </div>
    <br />
  <br />
  <br />
