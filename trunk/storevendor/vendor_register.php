...
if (isset($_POST['username'])) {
  ...
  $telephone = mysql_real_escape_string($_POST['telephone']);
	...
	$vendorMatch = mysql_num_rows($sql); // count the output amount
    if ($vendorMatch > 0) {
		echo 'Sorry you tried to place a duplicate "Username" into the system, <a href="vendor_register.php">click here</a>';
		exit();
	}
...
<body>
  ...
  <div id="pageContent"><br />
    <h3>
    &darr; Vendor Registration &darr;
    </h3>
    <form action="vendor_register.php" enctype="multipart/form-data" name="myForm" id="myform" method="post">
