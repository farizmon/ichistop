...
if (isset($_POST['product_name'])) {
  ...
  $quantity = mysql_real_escape_string($_POST['quantity']);
	...
	$sql = mysql_query("UPDATE products SET product_name='$product_name', price='$price', details='$details', category='$category', subcategory='$subcategory', quantity = '$quantity' WHERE id='$pid'");
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="6">
      ...
      <tr>
        ...
        <td><label>
		  ...
		  <a href="inventory_list.php"><input type="button" name="button" id="button" value="Back"/></a>
        </label></td>
      </tr>
    </table>
    </form>
