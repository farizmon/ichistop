...
if (isset($_POST['product_name'])) {
  ...
  $quantity = mysql_real_escape_string($_POST['quantity']);
	...
	$sql = mysql_query("INSERT INTO products (product_name, price, details, category, subcategory, date_added,manager,quantity) 
        VALUES('$product_name','$price','$details','$category','$subcategory',now()),'$manager','$quantity')") or die (mysql_error());
     $pid = mysql_insert_id();
...
<div align="left" style="margin-left:24px;">
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="6">
      ...
      <td>
        <label>
          <input name="quantity" type="text" id="quantity" size ="2" maxlength ="2">
        </label>
      </td>
      <tr>
