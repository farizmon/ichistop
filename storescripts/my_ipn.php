...
if (strpos($curl_result, "VERIFIED") !== false) {
	...
	mail("iferz17@gmail.com", "IPN interaction not verified", "$req", "From: iferz17@gmail.com" );
	exit();
}
...
if ($receiver_email != "iferz17@gmail.com") {
	$message = "Investigate why and how receiver email is wrong. Email = " . $_POST['receiver_email'] . "\n\n\n$req";
    mail("iferz17@gmail.com", "Receiver Email is incorrect", $message, "From: iferz17@gmail.com" );
    exit(); // exit script
}
// Check number 2 ------------------------------------------------------------------------------------------------------------
...
if ($numRows > 0) {
    ...
    mail("iferz17@gmail.com", "Duplicate txn_id in the IPN system", $message, "From: iferz17@gmail.com" );
    exit(); // exit script
} 
// Check number 4 ------------------------------------------------------------------------------------------------------------
...
if ($fullAmount != $grossAmount) {
        ...
        mail("iferz17@gmail.com", "Price Jack or Bad Programming", $message, "From: iferz17@gmail.com.com" );
        exit(); // exit script
} 
...
mail("iferz17@gmail.com", "NORMAL IPN RESULT YAY MONEY!", $req, "From: iferz17@gmail.com");
?>